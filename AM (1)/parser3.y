...
method_body
    : statement_list
    | error RBRACE { yyerrok; }  // Skip to the end of method body
    ;

statement_list
    : statement
    | statement_list statement
    | error SEMICOLON { yyerrok; }  // Skip erroneous statements
    ;
...
assignment_statement
    : IDENTIFIER ASSIGN expression SEMCOLON
    ;
...
block_statement
    ...
    | LBRACE error RBRACE { yyerrok; }  // Skip erroneous blocks
    ;
